...
<body>
	<div class="wrap">
		...
		<form class="well form-search" method="post" action="<?php echo U('Indexadmin/index');?>">
			...
			关键字： 
			<input type="text" name="keyword" style="width: 200px;" value="<?php echo I('request.keyword');?>" placeholder="用户名/昵称/邮箱/电话">
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
						...
						<td align="center">
							<?php if(($vo["id"]) != "1"): ?><a href="<?php echo U('indexadmin/detail',array('id'=>$vo['id']));?>">查看详情</a>|
								<a href="<?php echo U('indexadmin/listOrder',array('id'=>$vo['id']));?>">查看用户订单</a>|
