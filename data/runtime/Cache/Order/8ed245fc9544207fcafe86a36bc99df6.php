...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo U('AdminPage/index');?>">所有订单</a></li>
    </ul>

    <form class="well form-search" method="post" action="<?php echo U('Order/AdminOrder/orderList');?>">
    ...
    <form class="js-ajax-form" action="" method="post">
        <div class="table-actions">
            <button class="btn btn-danger btn-small js-ajax-submit" type="submit" data-action="<?php echo U('Order/AdminOrder/delete');?>" data-subcheck="true" data-msg="您确定删除吗？"><?php echo L('DELETE');?></button>
        </div>
        <table class="table table-hover table-bordered table-list">
            ...
            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                    ...
                    <td><?php echo ($vo["start_confinement"]); ?>——<?php echo ($vo["end_confinement"]); ?></td>
                    <td><?php echo ($vo["start_serve"]); ?>——<?php echo ($vo["end_serve"]); ?></td>
                    <td>
